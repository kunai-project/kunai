...
pub struct pt_regs {
    pub regs: [::core::ffi::c_ulong; 8usize],
    pub syscallno: __s32,
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg0(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg0_user(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg0_exists(pt_regs: *mut pt_regs) -> bool;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg1(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg1_user(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg1_exists(pt_regs: *mut pt_regs) -> bool;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg2(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg2_user(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg2_exists(pt_regs: *mut pt_regs) -> bool;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg3(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg3_user(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg3_exists(pt_regs: *mut pt_regs) -> bool;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg4(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg4_user(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg4_exists(pt_regs: *mut pt_regs) -> bool;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg5(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg5_user(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg5_exists(pt_regs: *mut pt_regs) -> bool;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg6(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg6_user(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg6_exists(pt_regs: *mut pt_regs) -> bool;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg7(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg7_user(pt_regs: *mut pt_regs) -> ::core::ffi::c_ulong;
}
unsafe extern "C" {
    pub fn shim_pt_regs_reg7_exists(pt_regs: *mut pt_regs) -> bool;
}
unsafe extern "C" {
    pub fn shim_pt_regs_syscallno(pt_regs: *mut pt_regs) -> ::core::ffi::c_int;
}
unsafe extern "C" {
    pub fn shim_pt_regs_syscallno_user(pt_regs: *mut pt_regs) -> ::core::ffi::c_int;
}
unsafe extern "C" {
    pub fn shim_pt_regs_syscallno_exists(pt_regs: *mut pt_regs) -> bool;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct kgid_t {
