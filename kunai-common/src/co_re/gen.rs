...
extern "C" {
    pub fn shim_iovec_iov_len(iovec: *mut iovec) -> ::core::ffi::c_uint;
}
extern "C" {
    pub fn shim_iovec_iov_len_user(iovec: *mut iovec) -> ::core::ffi::c_uint;
}
extern "C" {
...
extern "C" {
    pub fn shim_user_msghdr_msg_iovlen(user_msghdr: *mut user_msghdr) -> ::core::ffi::c_uint;
}
extern "C" {
    pub fn shim_user_msghdr_msg_iovlen_user(user_msghdr: *mut user_msghdr) -> ::core::ffi::c_uint;
}
extern "C" {
